<template>
  <el-image class="info-background" fit="cover" :src="configDetail.avatar_bg || infoBackground"></el-image>
  ...
  <div class="git-ee flex_r_around">
    <span class="git-ee__item button-animated">
      <i class="iconfont icon-gitee2" @click="operate('openLink', configDetail.git_ee_link)"> </i>
...
const infoBackground = ref(computer) // 博客头像背景
